...
| 周次 | 主题 | 篇数 | 状态 |
|------|------|------|------|
| Week 1 | AI 基础 | 11 篇 | ✅ 11/11 完成 |
| Week 2 | Web3 基础 | 10 篇 | ⬜ 未开始 |
| Week 3 | AI × Web3 Bridge | 14 篇 | ⬜ 未开始 |
| Week 4 | Tracks + 项目实践 | 待定 | ⬜ 未开始 |

## Week 1：AI 基础

| 序号 | 主题 | Handbook 链接 | 状态 |
|------|------|-------------|------|
| 1 | LLM 大语言模型 | [/ai/llm/](https://aiweb3.school/zh/handbook/ai/llm/) | ✅ |
| 2 | Prompt 提示词 | [/ai/prompt/](https://aiweb3.school/zh/handbook/ai/prompt/) | ✅ |
| 3 | Context 上下文 | [/ai/context/](https://aiweb3.school/zh/handbook/ai/context/) | ✅ |
| 4 | RAG 检索增强生成 | [/ai/rag/](https://aiweb3.school/zh/handbook/ai/rag/) | ✅ |
| 5 | Agent 智能体 | [/ai/agent/](https://aiweb3.school/zh/handbook/ai/agent/) | ✅ |
...
| 8 | Oracle 预言机 | [/web3/oracle/](https://aiweb3.school/zh/handbook/web3/oracle/) | ⬜ |
| 9 | Indexing 索引 | [/web3/indexing/](https://aiweb3.school/zh/handbook/web3/indexing/) | ⬜ |
| 10 | Security 安全 | [/web3/security/](https://aiweb3.school/zh/handbook/web3/security/) | ⬜ |

## 每日学习流程

1. 打开 [WCB Learning](https://web3career.build/zh/programs/AI-Web3-School#tab=learning) 确认今日任务
2. 阅读 Handbook 对应章节
3. 生成学习笔记 → `notes/week{N}/day{N}-{topic}.md`
4. 生成学习日志 → `logs/day{N}-{topic}-qa.md`
5. 提取 Prompt 记录 → `prompts/`
6. 更新 README 进度
7. 通过 Hermes Agent push 到 GitHub（经本人确认后执行）
